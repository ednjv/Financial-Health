  ...
  _data: {
    es: {
      ...
      settings: {
        ...
        labelFpCmfHeaderName: 'Nombre cabecera API key',
        labelFpCmfHeaderVal:  'Valor API key',
        ...
        fpHintCmfHeader:     'Nombre de la cabecera HTTP de autenticación requerida por CMF Chile (ej: apikey). Solo se envía si también se configura el valor.',
        fpHintCmfHeaderVal:  'Valor de la API key para CMF Chile. Si está vacío, no se envía la cabecera de autenticación.',
    ...
    en: {
      ...
      settings: {
        ...
        labelFpCmfHeaderName: 'API key header name',
        labelFpCmfHeaderVal:  'API key value',
        ...
        fpHintCmfHeader:     'Name of the HTTP authentication header required by CMF Chile (e.g. apikey). Only sent when a value is also configured.',
        fpHintCmfHeaderVal:  'API key value for CMF Chile. If empty, the authentication header will not be sent.',
