    ...
    es: {
      ...
      investments: {
        ...
        modal: {
          ...
          labelFintualId: 'Fintual Asset ID',
          helpFintualId: 'ID numérico del activo en Fintual (real_asset_id). Encuéntralo en la URL de tu fondo en fintual.cl o mediante el API: fintual.cl/api/asset_providers.',
          ...
          priceSrcYahoo: 'Yahoo Finance', priceSrcFintual: 'Fintual', priceSrcAlpha: 'Alpha Vantage',
      ...
      settings: {
        ...
        apiSourcesSection: 'Fuentes de API',
        apiActive:           'Activo',
        labelFpCmfUrl:       'URL API CMF Chile',
        labelFpYahooUrl:     'URL API Yahoo Finance',
        labelFpFintualUrl:   'URL API Fintual',
        labelFpCmfApiKey:    'API key (param apikey)',
        labelFpCmfFormato:   'Formato (param formato)',
        fpHintCmfUrl:        'URL base del API de CMF Chile. Usa {run} como marcador del RUN del fondo. Por defecto: endpoint de valores-cuota.',
        fpHintYahooUrl:      'URL base del API de Yahoo Finance. Usa {ticker} como marcador del símbolo. Por defecto: chart v8.',
        fpHintFintualUrl:    'URL base del API de Fintual. Usa {id} como marcador del Asset ID del fondo. Por defecto: endpoint de días de real_assets.',
        fpHintCmfApiKey:     'Valor de la API key de CMF Chile. Se envía como parámetro GET ?apikey=... en cada petición. Déjalo vacío si no tienes clave.',
        fpHintCmfFormato:    'Formato de respuesta solicitado al API de CMF. JSON es el único formato que puede ser procesado automáticamente.',
    ...
    en: {
      ...
      investments: {
        ...
        modal: {
          ...
          labelFintualId: 'Fintual Asset ID',
          helpFintualId: 'Numeric ID of the asset in Fintual (real_asset_id). Find it in your fund URL on fintual.cl or via the API: fintual.cl/api/asset_providers.',
      ...
      settings: {
        ...
        apiSourcesSection: 'API Sources',
        apiActive:           'Active',
        labelFpCmfUrl:       'CMF Chile API URL',
        labelFpYahooUrl:     'Yahoo Finance API URL',
        labelFpFintualUrl:   'Fintual API URL',
        labelFpCmfApiKey:    'API key (param apikey)',
        labelFpCmfFormato:   'Format (param formato)',
        fpHintCmfUrl:        'Base URL for the CMF Chile API. Use {run} as a placeholder for the fund RUN. Default: valores-cuota endpoint.',
        fpHintYahooUrl:      'Base URL for the Yahoo Finance API. Use {ticker} as a placeholder for the symbol. Default: chart v8.',
        fpHintFintualUrl:    'Base URL for the Fintual API. Use {id} as a placeholder for the Asset ID. Default: real_assets days endpoint.',
        fpHintCmfApiKey:     'CMF Chile API key value. Sent as GET parameter ?apikey=... in each request. Leave empty if you have no key.',
        fpHintCmfFormato:    'Response format requested from the CMF API. JSON is the only format that can be parsed automatically.',
